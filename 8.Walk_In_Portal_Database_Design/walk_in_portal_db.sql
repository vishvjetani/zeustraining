...
-- ALTER TABLE USERS ADD COLUMN DT_CREATED DATETIME DEFAULT CURRENT_TIMESTAMP;
-- ALTER TABLE USERS ADD COLUMN DT_MODIFIED DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP;
...
ALTER TABLE job_roles ADD COLUMN DT_CREATED DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE JOB_ROLES ADD COLUMN DT_MODIFIED DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP;
select * from user_job_roles;
...
SELECT  * FROM USER_EDUCATION_QUALIFICATIONS;
ALTER TABLE user_education_qualifications ADD COLUMN DT_CREATED DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE user_education_qualifications ADD COLUMN DT_MODIFIED DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP;
...
ALTER TABLE user_professional_qualifications ADD COLUMN DT_CREATED DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE user_professional_qualifications ADD COLUMN DT_MODIFIED DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP;

select * from user_professional_qualifications;

-- Dummy data for user_professional_qualifications
...
ALTER TABLE USER_TECHNOLOGIES ADD COLUMN DT_CREATED DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE USER_TECHNOLOGIES ADD COLUMN DT_MODIFIED DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP;

SELECT * FROM USER_TECHNOLOGIES;
...
`WALK_IN_JOB_ROLE_ID` INT PRIMARY KEY AUTO_INCREMENT,
  `WALK_IN_ID` INT NOT NULL,
  `ROLE_ID` INT NOT NULL,
  `GROSS_COMPENSATION` INT NOT NULL,
  `ROLE_DESCRIPTION` TEXT NOT NULL,
  `REQUIREMENTS` TEXT NOT NULL,
  UNIQUE `WALK_IN_JOB_ROLES_KEY` (`WALK_IN_ID`, `ROLE_ID`),
...
ALTER TABLE walk_in_time_slot ADD COLUMN DT_CREATED DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE walk_in_time_slot ADD COLUMN DT_MODIFIED DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP; 
...
ALTER TABLE user_walk_in ADD COLUMN DT_CREATED DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE user_walk_in ADD COLUMN DT_MODIFIED DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP; 
...
CREATE TABLE IF NOT EXISTS `walk_in_portal_DB`.`user_walk_in_job_roles` (
	`USER_WALK_IN_JOB_ROLE_ID` INT PRIMARY KEY AUTO_INCREMENT,
  `USER_ID` INT NOT NULL,
  `WALK_IN_ID` INT NOT NULL,
  `ROLE_ID` INT NOT NULL,
  UNIQUE KEY `USER_WALK_IN_JOB_ROLE_KEY` (`USER_ID`, `WALK_IN_ID`, `ROLE_ID`),
  CONSTRAINT `user_walk_in_job_roles_ibfk_1`
    FOREIGN KEY (`WALK_IN_ID`)
    REFERENCES `walk_in_portal_DB`.`walk_in` (`WALK_IN_ID`),
  CONSTRAINT `user_walk_in_job_roles_ibfk_2`
    FOREIGN KEY (`ROLE_ID`)
    REFERENCES `walk_in_portal_DB`.`job_roles` (`ROLE_ID`),
    CONSTRAINT `user_walk_in_job_roles_ibfk_3`
    FOREIGN KEY (`USER_ID`)
    REFERENCES `walk_in_portal_DB`.`USERS` (`USER_ID`));

ALTER TABLE user_walk_in_job_roles ADD COLUMN DT_CREATED DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE user_walk_in_job_roles ADD COLUMN DT_MODIFIED DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP; 

INSERT INTO `walk_in_portal_DB`.`user_walk_in_job_roles` (
    `USER_ID`,
    `WALK_IN_ID`,
    `ROLE_ID`
) VALUES 
