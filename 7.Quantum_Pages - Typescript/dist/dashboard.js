...
const fetchFunction_1 = require("./fetchFunction");
...
document.addEventListener("DOMContentLoaded", async () => {
    const courses = await (0, fetchFunction_1.default)("./scripts/courses.json");
    renderQuantumDashboard(courses);
    const alerts = await (0, fetchFunction_1.default)("./scripts/alerts.json");
    renderAlerts(alerts);
    const announcements = await (0, fetchFunction_1.default)("./scripts/announcements.json");
